<?php 
	...
	if (!empty($_POST['rn']) && isset($_POST['rn'])) {
		...
		if (!empty($_POST['prostredek']) && isset($_POST['prostredek'])) {
			if ($_POST['prostredek'] == "odrazedlo") {
				$kat = "A";
			} elseif ($_POST['rn'] == "2017" || $_POST['rn'] == "2016" || $_POST['rn'] == "2015" || $_POST['rn'] == "2018") {
				$kat = "B";
			} elseif ($_POST['rn'] == "2014" || $_POST['rn'] == "2013") {
				$kat = "C";
				...
				$kat = "F";
			} elseif ($_POST['rn'] == "2006" || $_POST['rn'] == "2005" || $_POST['rn'] == "2004") {
				$kat = "G";
			} else {
			}
		}
	...
	if (!empty($_POST['jmeno']) && isset($_POST['jmeno']) && 
		...
		if ($_POST['g-recaptcha-response']) {
			...
			mysqli_query($connection,"INSERT INTO deti2019(jmeno,prijmeni,bydliste,rn,kat,klub,pohlavi) VALUES('$jmeno','$prijmeni','$bydliste','$rn','$kategorie','$klub','$pohlavi')");
...
<body class="ch50-page" style="background-color:white;">
    ...
    <div class="ch50-container">
        ...
        <a href="./detske-zavody.php" class="back_home">
            ...
            <h1 class="prihlaska-heading" style="margin-top:40px;">DĚTSKÉ ZÁVODY - PŘIHLÁŠKA 2019</h1>
...
<form id="prihlaska" accept-charset="utf-8" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	<br>
	<br>
	<p>Online přihlašování bude ukončeno ve čtvrtek 23. května ve 20:00.</p>
	<br>
	<br>
	...
	$(window).on("load", function() {
        ...
        $(document).ready(function() {
			...
			$(".rn-cont .tile").on("click", function(){
				...
				} else if (dc == "2012" || dc == "2011" || dc == "2010" || dc == "2009" || dc == "2008" || dc == "2007" || dc == "2006" || dc == "2005" || dc == "2004" || dc == "2003" || dc == "2002" || dc == "2013" || dc == "2014" || dc == "2015") {
					if ($("#kolo").hasClass("disabled")) {
						$("#kolo").toggleClass("disabled");
						$("#kolo").toggleClass("selected");
					} 
