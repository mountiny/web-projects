...
if (!empty($_POST['rn']) && isset($_POST['rn'])) {
	...
	if (!empty($_POST['prostredek']) && isset($_POST['prostredek'])) {
		if ($_POST['prostredek'] == "odrazedlo") {
			$kat = "A";
		} elseif ($_POST['rn'] == "2016" || $_POST['rn'] == "2015" || $_POST['rn'] == "2014" || $_POST['rn'] == "2017") {
			$kat = "B";
		} elseif ($_POST['rn'] == "2013" || $_POST['rn'] == "2012") {
			$kat = "C";
			...
			$kat = "F";
		} elseif ($_POST['rn'] == "2005" || $_POST['rn'] == "2004" || $_POST['rn'] == "2003") {
			$kat = "G";
		} else {
		}
	}
  ...
  if (!empty($_POST['jmeno']) && isset($_POST['jmeno']) && 
     ...
     !empty($_POST['pohlavi']) && isset($_POST['pohlavi'])) {
  	...
  	if ($_POST['g-recaptcha-response']) {
	    ...
	    mysqli_query($connection,"INSERT INTO deti2018(jmeno,prijmeni,bydliste,rn,kat,klub,pohlavi) VALUES('$jmeno','$prijmeni','$bydliste','$rn','$kategorie','$klub','$pohlavi')");
	...
	<section id="section2" class="content cd-main-content">
		...
		<div class="aktualita propozice" style="padding-bottom: 30px;">
			...
			<form id="prihlaska" accept-charset="utf-8" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				...
				<br style="clear:both;" />
				<br>
				<div>Online přihlašování bude ukončeno ve čtvrtek 24. května ve 20:00.</div>
				<br>
				<div>Ti, jež se přihlásili online, již v dějišti závodů nevyplňují přihlášku znovu!!</div>
				<br>
				<div>
					Pořadatel se zavazuje, že Vaše osobní údaje neposkytne třetí osobě a&nbspzajistí jejich ochranu v&nbspsouladu se zákonem č. 101 / 2000 Sb., o&nbspochraně osobních údajů.
				</div>
				<br>
				<div>
