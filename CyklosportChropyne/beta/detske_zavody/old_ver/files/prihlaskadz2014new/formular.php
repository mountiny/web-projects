...
<title> Přihláška na dětské závody Chropyně 31.5. 2014</title>
</head>
<body>
<div id=obsah>
<form method="post" action="kontrola.php">
<h2>Přihláška na dětské závody Chropyně 31.5. 2014</h2>
...
<tr><td colspan="4">Za osoby mladších 18 let přihlášku odesílá jejich zákonný zástupce.</td></tr>
</table> <img src = "prihlaskabackground.png" alt="code" id="captcha"/> <br/> <br/> Opiš kód: <input type="text" name="kod" size="24"/> (nutno vyplnit zvýrazněné znaky) <br/> <br/> 
<input type="submit" value="Odeslat" name="odeslat"/> <input type="button" value="Obnovit" onClick="window.location.reload()"/><hr><p> Pořadatel se zavazuje, že Vaše osobní údaje neposkytne třetí osobě a zajistí jejich ochranu v souladu se zákonem č. 101 / 2000 Sb., o ochraně osobních údajů.</p></form></div><div id=hlavicka>
<!--<script type="text/javascript">
	document.getElementById('reset').onclick = window.location.reload(false);
</script>-->