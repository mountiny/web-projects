...
{*/
$textobrazku = "Chropyně";
if( $textobrazku == $_POST['kod'] )
{
...
<a href="http://www.cyklosportchropyne.cz/detskezavody/files/prihlaskadz2014new/formular.php">Zpět na formulář</a> <br><br>
...
else
{
 ...
 Echo '<a href="http://www.cyklosportchropyne.cz/detskezavody/files/prihlaskadz2014new/formular.php"> Jej, zkusím to znova </a>';
