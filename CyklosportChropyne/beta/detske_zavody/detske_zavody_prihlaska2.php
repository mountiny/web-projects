...
if (!empty($_POST['rn']) && isset($_POST['rn'])) {
	...
	if (!empty($_POST['prostredek']) && isset($_POST['prostredek'])) {
		if ($_POST['prostredek'] == "odrazedlo") {
			$kat = "A";
		} elseif ($_POST['rn'] == "2015" || $_POST['rn'] == "2014" || $_POST['rn'] == "2013" || $_POST['rn'] == "2016") {
			$kat = "B";
		} elseif ($_POST['rn'] == "2012" || $_POST['rn'] == "2011") {
			$kat = "C";
		} elseif ($_POST['rn'] == "2010" || $_POST['rn'] == "2009") {
			$kat = "D";
		} elseif ($_POST['rn'] == "2008" || $_POST['rn'] == "2007") {
			$kat = "E";
		} elseif ($_POST['rn'] == "2006" || $_POST['rn'] == "2005") {
			$kat = "F";
		} elseif ($_POST['rn'] == "2004" || $_POST['rn'] == "2003" || $_POST['rn'] == "2002") {
			$kat = "G";
		} else {
		}
	}
  ...
  if (!empty($_POST['jmeno']) && isset($_POST['jmeno']) && 
     ...
     !empty($_POST['pohlavi']) && isset($_POST['pohlavi'])) {
  	...
  	if ($_POST['g-recaptcha-response']) {
	    ...
	    mysqli_query($connection,"INSERT INTO deti2017(jmeno,prijmeni,bydliste,rn,kat,klub,pohlavi) VALUES('$jmeno','$prijmeni','$bydliste','$rn','$kategorie','$klub','$pohlavi')");
     ...
     !empty($_POST['bydliste']) || isset($_POST['bydliste']) ) {
  	...
  	$_SESSION['failure'] = "Nevyplnili jste nejméně jedno z požadovaných polí (jméno, příjmení, obec).";
		...
		<div class="aktualita propozice" style="padding-bottom: 30px;">
			...
			<form id="prihlaska" accept-charset="utf-8" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				...
				<div class="form-cont rn-cont">
					...
					<div class="tile" data-content="2002">
						<img src="../images/icons/n02.svg">
					</div>
					<div class="tile" data-content="2003">
						<img src="../images/icons/n03.svg">
					</div>
					<div class="tile" data-content="2004">
						<img src="../images/icons/n04.svg">
					</div>
		...
		<div class="aktualita" style="padding-bottom: 200px;">
			...
			<div class="textPropozic">
				<!-- <table class="seznamPrihlasenych"> -->
					...
					// include 'db_active_deti.php';
					// $connection->set_charset("utf8");
					// $sql2 = "SELECT id, prijmeni, jmeno, bydliste, rn, kat, klub FROM deti2017 ORDER BY  `deti2017`.`kat`, `deti2017`.`prijmeni` ASC";
...
<script type="text/javascript">
	...
	$(".rn-cont .tile").on("click", function(){
		...
		} else if (dc == "2012" || dc == "2011" || dc == "2010" || dc == "2009" || dc == "2008" || dc == "2007" || dc == "2006" || dc == "2005" || dc == "2004" || dc == "2003" || dc == "2002" || dc == "2013") {
			if ($("#kolo").hasClass("disabled")) {
				$("#kolo").toggleClass("disabled");
				$("#kolo").toggleClass("selected");
			} 
