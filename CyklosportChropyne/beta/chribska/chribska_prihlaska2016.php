...
//   echo 'Connected... ' . mysqli_get_host_info($link) . "\n"; 
 ...
 //     !empty($_POST['trasa']) && isset($_POST['trasa']
      ...
      mail($mailVlad, "Registrace závodníka", $messageVlad);

      mysqli_set_charset($connection,'utf8');

      mysqli_query($connection,"INSERT INTO zavodnici2016(prijmeni,jmeno,obec,psc,email,rok_narozeni,kategorie,tym,symbol,poradi,trasa) VALUES('$prijmeni','$jmeno','$obec','$psc','$mail','$rn','$kategorie','$klub','$symbol','$poradi','$trasa')");
